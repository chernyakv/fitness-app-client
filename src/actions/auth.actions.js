...
function resetPassword(password, newPassword) {
  ...
  function request() {
    return {type: constants.RESET_PASS_REQUEST}
  }

  function success() {
    return {type: constants.RESET_PASS_SUCCESS}
  }
}
...
function setCurrentUser(login) {
  ...
  function request() {
    return {type: constants.SET_CURRENT_USER_REQUEST}
  }

  function success(user) {
    return {type: constants.SET_CURRENT_USER_SUCCESS, user}
  }
}
